...
def simulate_trading(stock_symbols, initial_balance, initial_holdings):
    ...
    while True:
        for stock_symbol in stock_symbols:
            ...
            messages = [
                {
                    ...
                    \n\nBased on these current market conditions, please thoroughly look over your choices and make an educated decision. 
                    Please now create a response for the program."""
                }
            ]
            ...
            # Split the response safely
            response_parts = action_response.split()
            if len(response_parts) == 3:
                action, ticker, count = response_parts
                count = int(count)
                ...
                if action == "BUY":
                    ...
                    print(f"Unexpected AI response format: {action_response}")
